...
class VMManager(object):
    ...
    def __init__(self):
        ...
        access_key_id       = setting.get('nokkhum.ec2.access_key_id')
        secret_access_key   = setting.get('nokkhum.ec2.secret_access_key')
        host                = setting.get('nokkhum.ec2.host')
        port                = setting.get('nokkhum.ec2.port')
        secure              = setting.get('nokkhum.ec2.secure_connection')
        
        self.image_name = setting.get('nokkhum.ec2.image.name')
        self.instance_type = [image.strip() for image in setting.get('nokkhum.ec2.instance_type').split(',')]
